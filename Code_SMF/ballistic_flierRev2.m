function [state,covar] = ballistic_flierRev2(state0,tspan,tol)
% -------------------------------------------------------------------------
% Author:   Jorge O'Farrill/Stephen Forczyk
% Usage:    [state,covar] = ballistic_flier(state0,tspan,tol)
% Purpose:  create ballistic trajectory by propagating initial state,
%           state0 over a time span tspan using ode113 to solver J2 EOMs for
...
[t,st]  = ode113(@J2EOM,tspan,state0,opts); % solve EOMs defined by J2EOM
