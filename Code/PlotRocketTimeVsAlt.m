function PlotRocketTimeVsAlt(Time,Alt,titlestr,figstr)
% This routine will plot the object MachNum vs velocity
...
% Calculate the min and max values of Time and Alt to set
% the plot limits
...
% Now plot the Alt Vs Time as a line plot
movie_figure1=figure('position',[hor1 vert1 widd lend]);
set(gcf,'MenuBar','none');
set(gca,'Position',[.16 .18  .70 .70]);
plot(Time,Alt,'g');
xlabel('Time-sec','FontWeight','bold');
ylabel('Alt-km','FontWeight','bold');
