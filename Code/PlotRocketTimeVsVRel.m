function PlotRocketTimeVsVRel(Time,VRelSpeed,titlestr,figstr)
% This routine will plot the rocket relative sped vs time
...
% Now plot the VRel Vs Time as a line plot
movie_figure1=figure('position',[hor1 vert1 widd lend]);
set(gcf,'MenuBar','none');
set(gca,'Position',[.16 .18  .70 .70]);
plot(Time,VRelSpeed,'g');
xlabel('Time-sec','FontWeight','bold');
ylabel('VRelSpeed-km/sec','FontWeight','bold');
