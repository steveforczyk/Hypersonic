function PlotRocketTimeVsHeading(Time,Heading,titlestr,figstr)
% This routine will plot the rocket heading vs time
...
% Now plot the Heading Vs Time as a line plot
