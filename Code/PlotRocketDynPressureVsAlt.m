function PlotRocketDynPressureVsAlt(Alt,DynPressure,titlestr,figstr)
% This routine will plot the rocket DynPressure vs Alt
...
xmax=120;
ymin=0;
ymax1=max(DynPressure);
ymaxexp=nextpow2(ymax1);
ymax=2^ymaxexp;


% Now plot the DynamicPressure Vs Alt as a line plot
movie_figure1=figure('position',[hor1 vert1 widd lend]);
set(gcf,'MenuBar','none');
set(gca,'Position',[.16 .18  .70 .70]);
plot(Alt,DynPressure,'g');
xlabel('Alt-km','FontWeight','bold');
ylabel('m/sec^2','FontWeight','bold');
