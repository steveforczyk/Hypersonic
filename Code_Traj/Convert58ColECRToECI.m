...
elseif(icase==2)
    ...
    numfiles=length(FileList);
elseif(icase==3)
    topdir='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_all_objects_ECR\';
    jpegpath='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_ECR\Jpeg\';
    excelpath='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_ECR\Excel_Files\';
    [FileList] = getfilelist(topdir,'.asc','True');
    numfiles=length(FileList);
elseif(icase==4)
    sourcedir='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_all\Parsed\L128cD03P35_IR1_Barrow_ME\';
    destdir='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_all\Parsed_ECI\L128cD03P35_IR1_Barrow_ME\';
