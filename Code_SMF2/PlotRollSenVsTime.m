function PlotRollSenVsTime(Time1,RollSen,classification,titlestr,figstr)
% This routine will plot the RollSen angle calculated
% in SUMRYTRJ vs time
...
ymin=0;
ymax=360;
% Now plot the RollSen Values
% 
movie_figure1=figure('position',[hor1 vert1 widd lend]);
set(gcf,'MenuBar','none');
set(gca,'Position',[.16 .24 .70 .65]);
plot(Time1,RollSen,'r');

xlabel('Time-Sec','FontWeight','bold');
ylabel('TargetRollSenAngle Deg','FontWeight','bold');
