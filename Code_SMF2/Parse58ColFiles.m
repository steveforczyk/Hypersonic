...
elseif(icase==3)
    ...
    destdir='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_all\Parsed\';
    jpegpath='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_ECR\Jpeg\';
    excelpath='E:\Forczyk\Trajectories\Data3\L128cD03P35_IR1_Barrow_all_objects_ECR\Excel_Files\';
...
tic;
dispstr=strcat('Found-',num2str(numfiles,4),'-Files that may need to be split');
disp(dispstr);
Results=cell(1,1);
