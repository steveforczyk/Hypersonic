function PlotCalcRollAngleVsTime(Time1,CalcRoll,Time2,RollSen,...
    Time3,ZAng,classification,titlestr,figstr)
% This routine will plot calculated target roll angle
% angle wrt RollSen vs time
% Written By Stephen Forczyk
% Created May 9,2019
% Revised-My 11,2019 added comparison to RollSen
...
ymin=-360;
ymax=360;
% Now plot the Roll Angle Value
% 
movie_figure1=figure('position',[hor1 vert1 widd lend]);
set(gcf,'MenuBar','none');
set(gca,'Position',[.16 .24 .70 .65]);
plot(Time1,CalcRoll,'b',Time2,RollSen,'r',Time3,ZAng,'g');

xlabel('Time-Sec','FontWeight','bold');
ylabel('TargetRollAngle Deg','FontWeight','bold');
...
hl=legend('CalcRoll','RollSen','ZAng','Location','NorthWest');
