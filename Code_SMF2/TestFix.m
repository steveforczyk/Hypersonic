% This script will test the fix for the yaw angles for the 58 col
% files that were generated in ECI or ECF format
% 
...
global topdir destdir jpegpath;
...
% Get a shorter name to be used on the plot files
    ...
    dispstr=strcat('Processing File-',shortfilename);
    disp(dispstr);
% Now import this file
    [Data]=LoadBMRD58Rev2(filename);
